...
const QuinielaJ1 = {
matchesData: [
{ id: 1, local: 'Tigres', visit: 'Santos', imgL: 'logos/tigres.png', imgV: 'logos/santos.png' },
{ id: 2, local: 'Necaxa', visit: 'San Luis', imgL: 'logos/necaxa.png', imgV: 'logos/san luis.png' },
{ id: 3, local: 'Tijuana', visit: 'Puebla', imgL: 'logos/tijuana.png', imgV: 'logos/puebla.png' },
{ id: 4, local: 'Mazatlán', visit: 'Chivas', imgL: 'logos/mazatlan.png', imgV: 'logos/chivas.png' },
{ id: 5, local: 'Querétaro', visit: 'León', imgL: 'logos/queretaro.png', imgV: 'logos/leon.png' },
{ id: 6, local: 'Toluca', visit: 'Cruz Azul', imgL: 'logos/toluca.png', imgV: 'logos/cruz azul.png' },
{ id: 7, local: 'Atlas', visit: 'Pumas', imgL: 'logos/atlas.png', imgV: 'logos/pumas.png' },
{ id: 8, local: 'Pachuca', visit: 'Juárez', imgL: 'logos/pachuca.png', imgV: 'logos/juarez.png' },
{ id: 9, local: 'América', visit: 'Monterrey', imgL: 'logos/america.png', imgV: 'logos/monterrey.png' }
],
userSelections: {},
...
const fechaLimite = new Date('2026-02-06T15:00:00');
...
//===Horarios de los partidos y el movimiento===// //===Horarios de los partidos y el movimiento===// //===Horarios de los partidos y el movimiento===//
const matchesData = [
{ local: { name: 'Tigres', logo: 'logos/tigres.png' }, visitor: { name: 'Santos', logo: 'logos/santos.png' }, day: 'Viernes', hour: '7:00 PM', broadcaster: ['logos/fox sports.png', 'logos/tv azteca.png']},
{ local: { name: 'Necaxa', logo: 'logos/necaxa.png' }, visitor: { name: 'San Luis', logo: 'logos/san luis.png' }, day: 'Viernes', hour: '7:00 PM', broadcaster: ['logos/tv azteca.png', 'logos/vix.png']},
{ local: { name: 'Tijuana', logo: 'logos/tijuana.png' }, visitor: { name: 'Puebla', logo: 'logos/puebla.png' }, day: 'Viernes', hour: '9:00 PM', broadcaster: ['logos/fox sports.png']},
{ local: { name: 'Mazatlán', logo: 'logos/mazatlan.png' }, visitor: { name: 'Chivas', logo: 'logos/chivas.png' }, day: 'Viernes', hour: '9:06 PM', broadcaster: ['logos/fox sports.png', 'logos/tv azteca.png']},
{ local: { name: 'Querétaro', logo: 'logos/queretaro.png' }, visitor: { name: 'León', logo: 'logos/leon.png' }, day: 'Sábado', hour: '5:00 PM', broadcaster: ['logos/fox sports.png']},
{ local: { name: 'Toluca', logo: 'logos/toluca.png' }, visitor: { name: 'Cruz Azul', logo: 'logos/cruz azul.png' }, day: 'Sábado', hour: '5:00 PM', broadcaster: ['logos/tv azteca.png', 'logos/fox sports.png', 'logos/vix.png']},
{ local: { name: 'Atlas', logo: 'logos/atlas.png' }, visitor: { name: 'Pumas', logo: 'logos/pumas.png' }, day: 'Sábado', hour: '7:00 PM', broadcaster: ['logos/tudn.png', 'logos/vix.png']},
{ local: { name: 'Pachuca', logo: 'logos/pachuca.png' }, visitor: { name: 'Juárez', logo: 'logos/juarez.png' }, day: 'Sábado', hour: '7:00 PM', broadcaster: ['logos/fox sports.png']},
{ local: { name: 'América', logo: 'logos/america.png' }, visitor: { name: 'Monterrey', logo: 'logos/monterrey.png' }, day: 'Sábado', hour: '9:00 PM', broadcaster: ['logos/tudn.png', 'logos/vix.png']},
];
...
const PARTIDOS = [
{ local: 'Tigres', visitante: 'Santos' },
{ local: 'Necaxa', visitante: 'San Luis' },
{ local: 'Tijuana', visitante: 'Puebla' },
{ local: 'Mazatlan', visitante: 'Chivas' },
{ local: 'Queretaro', visitante: 'Leon' },
{ local: 'Toluca', visitante: 'Cruz Azul' },
{ local: 'Atlas', visitante: 'Pumas' },
{ local: 'Pachuca', visitante: 'Juarez' },
{ local: 'America', visitante: 'Monterrey' }
];
...
const partidos = [
{ id: 1, local: 'Tigres', visitante: 'Santos', logoLocal: 'logos/tigres.png', logoVisitante: 'logos/santos.png', claseLocal: 'tigres-local', claseVisitante: 'santos-visitante' },
{ id: 2, local: 'Necaxa', visitante: 'San Luis', logoLocal: 'logos/necaxa.png', logoVisitante: 'logos/san luis.png', claseLocal: 'necaxa-local', claseVisitante: 'san-luis-visitante' },
{ id: 3, local: 'Tijuana', visitante: 'Puebla', logoLocal: 'logos/tijuana.png', logoVisitante: 'logos/puebla.png', claseLocal: 'tijuana-local', claseVisitante: 'puebla-visitante' },
{ id: 4, local: 'Mazatlán', visitante: 'Chivas', logoLocal: 'logos/mazatlan.png', logoVisitante: 'logos/chivas.png', claseLocal: 'mazatlan-local', claseVisitante: 'chivas-visitante' },
{ id: 5, local: 'Querétaro', visitante: 'León', logoLocal: 'logos/queretaro.png', logoVisitante: 'logos/leon.png', claseLocal: 'queretaro-local', claseVisitante: 'leon-visitante' },
{ id: 6, local: 'Toluca', visitante: 'Cruz Azul', logoLocal: 'logos/toluca.png', logoVisitante: 'logos/cruz azul.png', claseLocal: 'toluca-local', claseVisitante: 'cruz-azul-visitante' },
{ id: 7, local: 'Atlas', visitante: 'Pumas', logoLocal: 'logos/atlas.png', logoVisitante: 'logos/pumas.png', claseLocal: 'atlas-local', claseVisitante: 'pumas-visitante' },
{ id: 8, local: 'Pachuca', visitante: 'Juárez', logoLocal: 'logos/pachuca.png', logoVisitante: 'logos/juarez.png', claseLocal: 'pachuca-local', claseVisitante: 'juarez-visitante' },
{ id: 9, local: 'América', visitante: 'Monterrey', logoLocal: 'logos/america.png', logoVisitante: 'logos/monterrey.png', claseLocal: 'america-local', claseVisitante: 'monterrey-visitante' }
];
