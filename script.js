...
const QuinielaJ1 = {
matchesData: [
{ id: 1, local: 'Puebla', visit: 'Pumas', imgL: 'logos/puebla.png', imgV: 'logos/pumas.png' },
{ id: 2, local: 'Juarez', visit: 'Necaxa', imgL: 'logos/juarez.png', imgV: 'logos/necaxa.png' },
{ id: 3, local: 'Toluca', visit: 'Tijuana', imgL: 'logos/toluca.png', imgV: 'logos/tijuana.png' },
{ id: 4, local: 'San Luis', visit: 'Querétaro', imgL: 'logos/san luis.png', imgV: 'logos/queretaro.png' },
{ id: 5, local: 'Monterrey', visit: 'León', imgL: 'logos/monterrey.png', imgV: 'logos/leon.png' },
{ id: 6, local: 'Pachuca', visit: 'Atlas', imgL: 'logos/pachuca.png', imgV: 'logos/atlas.png' },
{ id: 7, local: 'Chivas', visit: 'América', imgL: 'logos/chivas.png', imgV: 'logos/america.png' },
{ id: 8, local: 'Santos', visit: 'Mazatlán', imgL: 'logos/santos.png', imgV: 'logos/mazatlan.png' },
{ id: 9, local: 'Cruz Azul', visit: 'Tigres', imgL: 'logos/cruz azul.png', imgV: 'logos/tigres.png' }
],
userSelections: {},
...
const fechaLimite = new Date('2026-02-13T15:00:00');
...
const matchesData = [
{ local: { name: 'Puebla', logo: 'logos/puebla.png' }, visitor: { name: 'Pumas', logo: 'logos/pumas.png' }, day: 'Viernes', hour: '7:00 PM', broadcaster: ['logos/tv azteca.png']},
{ local: { name: 'Juarez', logo: 'logos/juarez.png' }, visitor: { name: 'Necaxa', logo: 'logos/necaxa.png' }, day: 'Sábado', hour: '7:00 PM', broadcaster: ['logos/vix.png']},
{ local: { name: 'Toluca', logo: 'logos/toluca.png' }, visitor: { name: 'Tijuana', logo: 'logos/tijuana.png' }, day: 'Viernes', hour: '9:00 PM', broadcaster: ['logos/tv azteca.png']},
{ local: { name: 'San Luis', logo: 'logos/san luis.png' }, visitor: { name: 'Querétaro', logo: 'logos/queretaro.png' }, day: 'Sábado', hour: '5:00 PM', broadcaster: ['logos/vix.png']},
{ local: { name: 'Monterrey', logo: 'logos/monterrey.png' }, visitor: { name: 'León', logo: 'logos/leon.png' }, day: 'Sábado', hour: '7:00 PM', broadcaster: ['logos/tudn.png', 'logos/vix.png']},
{ local: { name: 'Pachuca', logo: 'logos/pachuca.png' }, visitor: { name: 'Atlas', logo: 'logos/atlas.png' }, day: 'Sábado', hour: '5:00 PM', broadcaster: ['logos/fox sports.png']},
{ local: { name: 'Chivas', logo: 'logos/chivas.png' }, visitor: { name: 'América', logo: 'logos/america.png' }, day: 'Sábado', hour: '9:07 PM', broadcaster: ['logos/amazon prime.png']},
{ local: { name: 'Santos', logo: 'logos/santos.png' }, visitor: { name: 'Mazatlán', logo: 'logos/mazatlan.png' }, day: 'Domingo', hour: '5:00 PM', broadcaster: ['logos/tudn.png', 'logos/vix.png']},
{ local: { name: 'Cruz Azul', logo: 'logos/cruz azul.png' }, visitor: { name: 'Tigres', logo: 'logos/tigres.png' }, day: 'Domingo', hour: '4:30 PM', broadcaster: ['logos/tudn.png', 'logos/vix.png', 'logos/tv azteca.png']},
];
...
const PARTIDOS = [
{ local: 'Puebla', visitante: 'Pumas' },
{ local: 'Juarez', visitante: 'Necaxa' },
{ local: 'Toluca', visitante: 'Tijuana' },
{ local: 'San Luis', visitante: 'Queretaro' },
{ local: 'Monterrey', visitante: 'Leon' },
{ local: 'Pachuca', visitante: 'Atlas' },
{ local: 'Chivas', visitante: 'America' },
{ local: 'Santos', visitante: 'Mazatlan' },
{ local: 'Cruz Azul', visitante: 'Tigres' }
];
...
const partidos = [
{ id: 1, local: 'Puebla', visitante: 'Pumas', logoLocal: 'logos/puebla.png', logoVisitante: 'logos/pumas.png', claseLocal: 'puebla-local', claseVisitante: 'pumas-visitante' },
{ id: 2, local: 'Juarez', visitante: 'Necaxa', logoLocal: 'logos/juarez.png', logoVisitante: 'logos/necaxa.png', claseLocal: 'juarez-local', claseVisitante: 'necaxa-visitante' },
{ id: 3, local: 'Toluca', visitante: 'Tijuana', logoLocal: 'logos/toluca.png', logoVisitante: 'logos/tijuana.png', claseLocal: 'toluca-local', claseVisitante: 'tijuana-visitante' },
{ id: 4, local: 'San Luis', visitante: 'Querétaro', logoLocal: 'logos/san luis.png', logoVisitante: 'logos/queretaro.png', claseLocal: 'san-luis-local', claseVisitante: 'queretaro-visitante' },
{ id: 5, local: 'Monterrey', visitante: 'León', logoLocal: 'logos/monterrey.png', logoVisitante: 'logos/leon.png', claseLocal: 'monterrey-local', claseVisitante: 'leon-visitante' },
{ id: 6, local: 'Pachuca', visitante: 'Atlas', logoLocal: 'logos/pachuca.png', logoVisitante: 'logos/atlas.png', claseLocal: 'pachuca-local', claseVisitante: 'atlas-visitante' },
{ id: 7, local: 'Chivas', visitante: 'América', logoLocal: 'logos/chivas.png', logoVisitante: 'logos/america.png', claseLocal: 'chivas-local', claseVisitante: 'america-visitante' },
{ id: 8, local: 'Santos', visitante: 'Mazatlán', logoLocal: 'logos/santos.png', logoVisitante: 'logos/mazatlan.png', claseLocal: 'santos-local', claseVisitante: 'mazatlan-visitante' },
{ id: 9, local: 'Cruz Azul', visitante: 'Tigres', logoLocal: 'logos/cruz azul.png', logoVisitante: 'logos/tigres.png', claseLocal: 'cruz-azul-local', claseVisitante: 'tigres-visitante' }
];
